...
Token-optimized [Claude](https://www.anthropic.com/) text optimizer. Point it at a
**Word document** (`.docx`) or text file, and it shrinks the text before it ever reaches
